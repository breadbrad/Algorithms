...
class SortLageFile {
        ...
        public static void sort(String sourceFile, String targetFile) throws Exception {
               ...
               /** Implement Phase 2 : Merge segment recursively */        
               merge(numberofSegments, MAX_ARRAY_SIZE, "f1.dat", "f2.dat", "f3.dat", targetfile);
        }

        
        public static int initializeSegment(int segmentSize, String originalFile, String f1) throws Exception {
                ...
                while (input.available() > 0) {
                       int i = 0;
                       for (; i < input.available() && i < segmentSize; i++) 
                                 list[i] = input.readInt();
                        // sort the array list[0 .. i-1]
                       java.util.Array(list, 0, i);
       ...
       private static void merge(int numberOfSegments, int segmentSize, String f1, String f2, String f3, String targetfile) throws Exception {
                if( numberofSegments > 1) {
                        ...
                        if (sortedFile.exist()) sortedFile.delete();
        ...
        private static void mergeOneStep(int numberofSegments, int segmentSize, String f1, String f2, String f3) throws Exception {
                ...
                DataOutputStream f2Output = new DataOutputStream(new BufferedInputStream(new FileOutputStream(f2), BUFFER_SIZE));
                ...
                DataOutputStream f3Output = new DataOutputStream(new BufferedInputStream(new FileOutputStream(f3), BUFFER_SIZE));
        ...
        private static void copyHalfToF2 (int numberOfSegment, int segmentSize, DataInputStream f1, DataOutputStream f2) throws Exception {
                for (int i = 0; i < (numberOfSegments / 2) * segmentSize; i++)
                        f2.writeInt(f1.readInt());
        }


        private static void mergeSegments (int numberOfSegment, int segmentSize, DataInputStream f1, DataInputStream f2, DataOutputStream f3) throws Exception {
        ...
        private static void mergeTwoSegments(int segmentSize, DataInputStream f1, DataInputStream f2, DataOuputStream f3) throws Exception {
